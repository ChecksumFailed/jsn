...
func buildActionInsertMutation(flowSysID, actionTypeSysID, actionType, table string, inputs map[string]string, parentUIID string, order string) string {
	...
	case "ask_approval":
		inputsJSON = buildAskApprovalInputs(inputs)
	default:
		inputsJSON = "[]"
	}
...
// buildAskApprovalInputs builds the inputs JSON for an Ask for Approval action.
// This creates the action with empty values - the actual values are set via UPDATE mutation.
func buildAskApprovalInputs(inputs map[string]string) string {
	// Insert with empty values - the actual values are set via UPDATE mutation
	return `[{id: "78f2e9920b10030085c083eb37673ac0", name: "record", children: [], displayValue: {value: ""}, value: {value: ""}, parameter: {id: "78f2e9920b10030085c083eb37673ac0", label: "Record", name: "record", type: "document_id", type_label: "Document ID", hint: "", order: 0, extended: false, mandatory: true, readonly: false, maxsize: 32, data_structure: "", reference: "", reference_display: "", ref_qual: "", choiceOption: "", table: "", columnName: "", defaultValue: "", use_dependent: true, dependent_on: "table", show_ref_finder: false, local: false, attributes: "element_mapping_provider=com.glide.flow_design.action.data.FlowDesignVariableMapper,", sys_class_name: "", children: [], dynamic: null}}, {id: "bcf2e9920b10030085c083eb37673acc", name: "table", children: [], displayValue: {value: ""}, value: {value: ""}, parameter: {id: "bcf2e9920b10030085c083eb37673acc", label: "Table", name: "table", type: "table_name", type_label: "Table Name", hint: "", order: 1, extended: false, mandatory: false, readonly: true, maxsize: 80, data_structure: "", reference: "", reference_display: "", ref_qual: "", choiceOption: "", table: "", columnName: "", defaultValue: "", use_dependent: false, dependent_on: "", show_ref_finder: false, local: false, attributes: "element_mapping_provider=com.glide.flow_design.action.data.FlowDesignVariableMapper,", sys_class_name: "", children: [], dynamic: null}}, {id: "e4635e467f3012108e688c90ac866543", name: "approval_reason", children: [], displayValue: {value: ""}, value: {value: ""}, parameter: {id: "e4635e467f3012108e688c90ac866543", label: "Approval Reason", name: "approval_reason", type: "string", type_label: "String", hint: "", order: 2, extended: false, mandatory: false, readonly: false, maxsize: 160, data_structure: "", reference: "", reference_display: "", ref_qual: "", choiceOption: "", table: "", columnName: "", defaultValue: "", use_dependent: false, dependent_on: "", show_ref_finder: false, local: false, attributes: "uiTypeLabel=String,element_mapping_provider=com.glide.flow_design.action.data.FlowDesignVariableMapper,uiType=string,uiUniqueId=62b6908d-df0b-4835-ace0-e615e5d6c513,", sys_class_name: "", children: [], dynamic: null}}, {id: "01f2e9920b10030085c083eb37673ad8", name: "approval_field", children: [], displayValue: {value: ""}, value: {value: ""}, parameter: {id: "01f2e9920b10030085c083eb37673ad8", label: "Approval Field", name: "approval_field", type: "field_name", type_label: "Field Name", hint: "", order: 2, extended: false, mandatory: false, readonly: false, maxsize: 8000, data_structure: "", reference: "", reference_display: "", ref_qual: "", choiceOption: "", table: "", columnName: "", defaultValue: "", use_dependent: true, dependent_on: "table", show_ref_finder: false, local: false, attributes: "element_mapping_provider=com.glide.flow_design.action.data.FlowDesignVariableMapper,", sys_class_name: "", children: [], dynamic: null}}, {id: "c1f2e9920b10030085c083eb37673ae3", name: "journal_field", children: [], displayValue: {value: ""}, value: {value: ""}, parameter: {id: "c1f2e9920b10030085c083eb37673ae3", label: "Journal Field", name: "journal_field", type: "field_name", type_label: "Field Name", hint: "", order: 3, extended: false, mandatory: false, readonly: false, maxsize: 8000, data_structure: "", reference: "", reference_display: "", ref_qual: "", choiceOption: "", table: "", columnName: "", defaultValue: "", use_dependent: true, dependent_on: "table", show_ref_finder: false, local: false, attributes: "element_mapping_provider=com.glide.flow_design.action.data.FlowDesignVariableMapper,", sys_class_name: "", children: [], dynamic: null}}, {id: "45f2e9920b10030085c083eb37673aee", name: "approval_conditions", children: [], displayValue: {value: ""}, value: {value: ""}, parameter: {id: "45f2e9920b10030085c083eb37673aee", label: "Rules", name: "approval_conditions", type: "approval_rules", type_label: "Approval Rules", hint: "", order: 4, extended: false, mandatory: true, readonly: false, maxsize: 8000, data_structure: "", reference: "", reference_display: "", ref_qual: "", choiceOption: "", table: "", columnName: "", defaultValue: "", use_dependent: false, dependent_on: "", show_ref_finder: false, local: false, attributes: "element_mapping_provider=com.glide.flow_design.action.data.FlowDesignVariableMapper,", sys_class_name: "", children: [], dynamic: null}}, {id: "c5f2e9920b10030085c083eb37673af9", name: "due_date", children: [], displayValue: {value: ""}, value: {value: ""}, parameter: {id: "c5f2e9920b10030085c083eb37673af9", label: "Due Date", name: "due_date", type: "schedule_date_time", type_label: "Schedule Date/Time", hint: "", order: 5, extended: false, mandatory: false, readonly: false, maxsize: 40, data_structure: "", reference: "", reference_display: "", ref_qual: "", choiceOption: "", table: "", columnName: "", defaultValue: "", use_dependent: false, dependent_on: "", show_ref_finder: false, local: false, attributes: "ui_approval=true,element_mapping_provider=com.glide.flow_design.action.data.FlowDesignVariableMapper,", sys_class_name: "", children: [], dynamic: null}}]`
}
